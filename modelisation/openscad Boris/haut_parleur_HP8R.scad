...
module haut_parleur_HP8R_trousFixation() {
	...
	translate([HP8R_diametre_creuse_coins / 4, HP8R_diametre_creuse_coins / 4, -difference_objet_marge/2])
		cylinder(HP8R_epaisseur_tole + difference_objet_marge, d=HP8R_diametre_creuse_fixation, $fn=resolution);
	translate([HP8R_largeur - HP8R_diametre_creuse_coins / 2 + HP8R_diametre_creuse_coins / 4, HP8R_diametre_creuse_coins / 4, -difference_objet_marge/2])
		cylinder(HP8R_epaisseur_tole + difference_objet_marge, d=HP8R_diametre_creuse_fixation, $fn=resolution);
	translate([HP8R_diametre_creuse_coins / 4, HP8R_hauteur - HP8R_diametre_creuse_coins / 2 + HP8R_diametre_creuse_coins / 4, -difference_objet_marge/2])
		cylinder(HP8R_epaisseur_tole + difference_objet_marge, d=HP8R_diametre_creuse_fixation, $fn=resolution);
	translate([HP8R_largeur - HP8R_diametre_creuse_coins / 2 + HP8R_diametre_creuse_coins / 4, HP8R_hauteur - HP8R_diametre_creuse_coins / 2 + HP8R_diametre_creuse_coins / 4, -difference_objet_marge/2])
		cylinder(HP8R_epaisseur_tole + difference_objet_marge, d=HP8R_diametre_creuse_fixation, $fn=resolution);
}
